...
:Extension name: Validation examples (new property mapper)
:Extension key: validation_examples_new
:Version: 
:Description: manuals covering TYPO3 extension "Validation examples (new property mapper)"
:Language: en
