...
/**
 * Test case for class Tx_Validation_examples_new_Controller_AddressdataController.
 *
 * @version $Id$
 ...
 */
class AddressdataControllerTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var 
	 */
	protected $fixture;
